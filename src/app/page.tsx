...
const StatsCapsule = () => {
  return (
    <div className="relative w-full mx-auto">
      ...
      <div className="relative bg-white border border-surface-border rounded-[2.5rem] md:rounded-full shadow-sm py-8 px-8 md:px-16 grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-6 w-full">
